...
iterator make_iterator(Iterator first, Iterator last, Extra &&... extra) {
    ...
    typedef typename std::conditional<
        ...
        std::integral_constant<return_value_policy, return_value_policy::reference_internal>,
        std::integral_constant<return_value_policy, return_value_policy::automatic>>::type ret_policy;
    ...
    if (!detail::get_type_info(typeid(state))) {
        class_<state>(handle(), "")
            ...
            .def("__next__", [](state &s) -> ValueType {
                ...
                return *s.it;
            }, ret_policy::value, std::forward<Extra>(extra)...);
    }
